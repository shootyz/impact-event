...
export type NewsBlock = { type: "news"; title: string; content: string; image_url?: string; cta_label?: string; cta_url?: string };
...
${calMapsLinks.length ? `<table cellpadding="0" cellspacing="0" style="margin-bottom:24px;"><tr>${calMapsLinks.map(l => `<td style="padding-right:20px;">${l}</td>`).join("")}</tr></table>` : ""}`;
  ...
  <table width="100%" cellpadding="0" cellspacing="0"><tr>
    <td width="45%" style="font-size:0;line-height:0;">
      <div style="height:0;overflow:hidden;margin-top:8px;border-top:1px solid ${D.gray2};font-size:0;line-height:0;">&nbsp;</div>
    </td>
