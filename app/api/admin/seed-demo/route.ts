...
export async function POST(req: NextRequest) {
  ...
  // ── 3. Members ──
  const memberZgByEmail: Record<string, string> = {
    'k.vonarx@demo.ch': zgVip.id, 't.mueller@demo.ch': zgVip.id, 's.reuter@demo.ch': zgVip.id,
    'm.steinberg@demo.ch': zgVip.id, 'e.braun@demo.ch': zgVip.id, 'c.dupont@demo.fr': zgVip.id,
    'p.martin@demo.fr': zgVip.id, 'j.whitfield@demo.com': zgVip.id, 's.collins@demo.com': zgVip.id,
    'a.keller@partner.ch': zgPartner.id, 'm.huber@partner.ch': zgPartner.id, 'c.bauer@partner.ch': zgPartner.id,
    'l.fischer@partner.ch': zgPartner.id, 'm.hart@partner.com': zgPartner.id,
    'j.weber@media.ch': zgMedia.id, 'd.schmid@media.ch': zgMedia.id, 'l.koch@media.ch': zgMedia.id,
    'h.zimmer@demo.ch': zgVip.id,
  }
  const memberRows = [
    // VIP DE
    { event_id: eventId, first_name: 'Katharina', last_name: 'von Arx', email: 'k.vonarx@demo.ch', anrede: 'Frau', sprache: 'de', unsubscribe_token: randomUUID(), unsubscribed: false },
    { event_id: eventId, first_name: 'Thomas', last_name: 'Müller', email: 't.mueller@demo.ch', anrede: 'Herr', sprache: 'de', unsubscribe_token: randomUUID(), unsubscribed: false },
    { event_id: eventId, first_name: 'Sophie', last_name: 'Reuter', email: 's.reuter@demo.ch', anrede: 'Frau', sprache: 'de', unsubscribe_token: randomUUID(), unsubscribed: false },
    { event_id: eventId, first_name: 'Markus', last_name: 'Steinberg', email: 'm.steinberg@demo.ch', anrede: 'Herr', sprache: 'de', unsubscribe_token: randomUUID(), unsubscribed: false },
    { event_id: eventId, first_name: 'Elena', last_name: 'Braun', email: 'e.braun@demo.ch', anrede: 'Frau', sprache: 'de', unsubscribe_token: randomUUID(), unsubscribed: false },
    { event_id: eventId, first_name: 'Claire', last_name: 'Dupont', email: 'c.dupont@demo.fr', anrede: 'Frau', sprache: 'fr', unsubscribe_token: randomUUID(), unsubscribed: false },
    { event_id: eventId, first_name: 'Pierre', last_name: 'Martin', email: 'p.martin@demo.fr', anrede: 'Herr', sprache: 'fr', unsubscribe_token: randomUUID(), unsubscribed: false },
    { event_id: eventId, first_name: 'James', last_name: 'Whitfield', email: 'j.whitfield@demo.com', anrede: 'Herr', sprache: 'en', unsubscribe_token: randomUUID(), unsubscribed: false },
    { event_id: eventId, first_name: 'Sarah', last_name: 'Collins', email: 's.collins@demo.com', anrede: 'Frau', sprache: 'en', unsubscribe_token: randomUUID(), unsubscribed: false },
    { event_id: eventId, first_name: 'Andreas', last_name: 'Keller', email: 'a.keller@partner.ch', anrede: 'Herr', sprache: 'de', unsubscribe_token: randomUUID(), unsubscribed: false },
    { event_id: eventId, first_name: 'Monika', last_name: 'Huber', email: 'm.huber@partner.ch', anrede: 'Frau', sprache: 'de', unsubscribe_token: randomUUID(), unsubscribed: false },
    { event_id: eventId, first_name: 'Christian', last_name: 'Bauer', email: 'c.bauer@partner.ch', anrede: 'Herr', sprache: 'de', unsubscribe_token: randomUUID(), unsubscribed: false },
    { event_id: eventId, first_name: 'Laura', last_name: 'Fischer', email: 'l.fischer@partner.ch', anrede: 'Frau', sprache: 'de', unsubscribe_token: randomUUID(), unsubscribed: false },
    { event_id: eventId, first_name: 'Michael', last_name: 'Hart', email: 'm.hart@partner.com', anrede: 'Herr', sprache: 'en', unsubscribe_token: randomUUID(), unsubscribed: false },
    { event_id: eventId, first_name: 'Julia', last_name: 'Weber', email: 'j.weber@media.ch', anrede: 'Frau', sprache: 'de', unsubscribe_token: randomUUID(), unsubscribed: false },
    { event_id: eventId, first_name: 'David', last_name: 'Schmid', email: 'd.schmid@media.ch', anrede: 'Herr', sprache: 'de', unsubscribe_token: randomUUID(), unsubscribed: false },
    { event_id: eventId, first_name: 'Lena', last_name: 'Koch', email: 'l.koch@media.ch', anrede: 'Frau', sprache: 'de', unsubscribe_token: randomUUID(), unsubscribed: false },
    { event_id: eventId, first_name: 'Hans', last_name: 'Zimmer', email: 'h.zimmer@demo.ch', anrede: 'Herr', sprache: 'de', unsubscribed: true, unsubscribe_token: randomUUID() },
  ]
  ...
  const zgLinkRows = (members as { id: string; email: string }[])
    .filter((m) => memberZgByEmail[m.email])
    .map((m) => ({ member_id: m.id, zielgruppe_id: memberZgByEmail[m.email] }))
  await db.from('member_zielgruppen').insert(zgLinkRows)
